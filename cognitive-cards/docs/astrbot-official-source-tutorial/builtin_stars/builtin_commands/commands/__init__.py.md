# 文件教程：builtin_stars/builtin_commands/commands/__init__.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\builtin_stars\builtin_commands\commands\__init__.py`
- 文件类型：`.py`
- 文件大小：`336` 字节
