# 目录教程：builtin_stars/web_searcher/engines

## 目录定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\builtin_stars\web_searcher\engines`
- 相对根目录：`builtin_stars/web_searcher/engines`
- 直接子目录数：`0`
- 直接文件数：`0`
- 直接 Python 文件数：`0`
