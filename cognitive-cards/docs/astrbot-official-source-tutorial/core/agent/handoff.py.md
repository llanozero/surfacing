# 文件教程：core/agent/handoff.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\agent\handoff.py`
- 文件类型：`.py`
- 文件大小：`2816` 字节
...
- `HandoffTool`：Handoff tool for delegating tasks to another agent
