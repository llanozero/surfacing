# 文件教程：core/agent/run_context.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\agent\run_context.py`
- 文件类型：`.py`
- 文件大小：`700` 字节
...
- `ContextWrapper`：A context for running an agent, which can be used to pass additional data or state
