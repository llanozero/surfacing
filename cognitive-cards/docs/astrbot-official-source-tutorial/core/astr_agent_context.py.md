# 文件教程：core/astr_agent_context.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\astr_agent_context.py`
- 文件类型：`.py`
- 文件大小：`658` 字节
...
这个文件主要定义了 AstrAgentContext 等顶层类。
...
- `AstrAgentContext`：建议阅读类定义与方法名来判断职责。
