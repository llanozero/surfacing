# 文件教程：core/computer/booters/base.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\computer\booters\base.py`
- 文件类型：`.py`
- 文件大小：`1335` 字节
...
- `ComputerBooter`：建议阅读类定义与方法名来判断职责。
