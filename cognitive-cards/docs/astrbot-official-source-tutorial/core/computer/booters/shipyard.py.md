# 文件教程：core/computer/booters/shipyard.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\computer\booters\shipyard.py`
- 文件类型：`.py`
- 文件大小：`5342` 字节
...
这个文件主要定义了 ShipyardFileSystemWrapper、ShipyardBooter 等顶层类。
...
- `ShipyardFileSystemWrapper`：建议阅读类定义与方法名来判断职责。
- `ShipyardBooter`：建议阅读类定义与方法名来判断职责。
