# 文件教程：core/file_token_service.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\file_token_service.py`
- 文件类型：`.py`
- 文件大小：`3431` 字节
...
这个文件主要定义了 FileTokenService 等顶层类。
...
- `FileTokenService`：维护一个简单的基于令牌的文件下载服务，支持超时和懒清除
