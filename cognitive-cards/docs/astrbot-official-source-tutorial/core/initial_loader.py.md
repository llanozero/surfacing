# 文件教程：core/initial_loader.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\initial_loader.py`
- 文件类型：`.py`
- 文件大小：`1875` 字节
...
- `InitialLoader`：AstrBot 启动器，负责初始化和启动核心组件和仪表板服务器
