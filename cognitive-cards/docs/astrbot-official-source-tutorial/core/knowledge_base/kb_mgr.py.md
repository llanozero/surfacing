# 文件教程：core/knowledge_base/kb_mgr.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\knowledge_base\kb_mgr.py`
- 文件类型：`.py`
- 文件大小：`14745` 字节
...
这个文件主要定义了 KnowledgeBaseManager 等顶层类。
...
- `KnowledgeBaseManager`：建议阅读类定义与方法名来判断职责。
