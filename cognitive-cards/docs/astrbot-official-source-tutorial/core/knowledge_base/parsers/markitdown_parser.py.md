# 文件教程：core/knowledge_base/parsers/markitdown_parser.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\knowledge_base\parsers\markitdown_parser.py`
- 文件类型：`.py`
- 文件大小：`727` 字节
...
这个文件主要定义了 MarkitdownParser 等顶层类。
...
- `MarkitdownParser`：解析 docx, xls, xlsx 格式
