# 文件教程：core/knowledge_base/parsers/text_parser.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\knowledge_base\parsers\text_parser.py`
- 文件类型：`.py`
- 文件大小：`1137` 字节
