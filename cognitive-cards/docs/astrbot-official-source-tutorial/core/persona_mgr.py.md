# 文件教程：core/persona_mgr.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\persona_mgr.py`
- 文件类型：`.py`
- 文件大小：`16170` 字节
...
- `PersonaManager`：建议阅读类定义与方法名来判断职责。
