# 文件教程：core/pipeline/context.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\pipeline\context.py`
- 文件类型：`.py`
- 文件大小：`619` 字节
...
这个文件主要定义了 PipelineContext 等顶层类。
...
- `PipelineContext`：上下文对象，包含管道执行所需的上下文信息
