# 文件教程：core/platform/message_session.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\platform\message_session.py`
- 文件类型：`.py`
- 文件大小：`1142` 字节
...
- `MessageSession`：描述一条消息在 AstrBot 中对应的会话的唯一标识
