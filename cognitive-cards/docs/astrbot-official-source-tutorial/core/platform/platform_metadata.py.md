# 文件教程：core/platform/platform_metadata.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\platform\platform_metadata.py`
- 文件类型：`.py`
- 文件大小：`1345` 字节
...
这个文件主要定义了 PlatformMetadata 等顶层类。
...
- `PlatformMetadata`：建议阅读类定义与方法名来判断职责。
