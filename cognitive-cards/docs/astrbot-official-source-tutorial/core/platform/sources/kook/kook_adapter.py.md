# 文件教程：core/platform/sources/kook/kook_adapter.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\platform\sources\kook\kook_adapter.py`
- 文件类型：`.py`
- 文件大小：`20200` 字节
...
这个文件主要定义了 KookPlatformAdapter 等顶层类。
...
- `from kook_types import ContainerModule, FileModule, HeaderModule, ImageGroupModule, KmarkdownElement, KookCardMessageContainer`

## 顶层类

- `KookPlatformAdapter`：建议阅读类定义与方法名来判断职责。
