# 文件教程：core/platform/sources/wecom/wecom_event.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\platform\sources\wecom\wecom_event.py`
- 文件类型：`.py`
- 文件大小：`14182` 字节
...
这个文件主要定义了 WecomPlatformEvent 等顶层类。
...
- `WecomPlatformEvent`：建议阅读类定义与方法名来判断职责。
...
- [wecom_adapter.py](wecom_adapter.py.md)
