# 文件教程：core/provider/sources/gemini_embedding_source.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\provider\sources\gemini_embedding_source.py`
- 文件类型：`.py`
- 文件大小：`3272` 字节
...
这个文件主要定义了 GeminiEmbeddingProvider 等顶层类。
...
- `GeminiEmbeddingProvider`：建议阅读类定义与方法名来判断职责。
