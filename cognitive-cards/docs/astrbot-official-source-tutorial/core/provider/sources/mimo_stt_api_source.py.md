# 文件教程：core/provider/sources/mimo_stt_api_source.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\provider\sources\mimo_stt_api_source.py`
- 文件类型：`.py`
- 文件大小：`3562` 字节
...
这个文件主要定义了 ProviderMiMoSTTAPI 等顶层类。
...
- `from mimo_api_common import DEFAULT_MIMO_API_BASE, DEFAULT_MIMO_STT_MODEL, DEFAULT_MIMO_STT_SYSTEM_PROMPT, DEFAULT_MIMO_STT_USER_PROMPT, MiMoAPIError, build_api_url`

## 顶层类

- `ProviderMiMoSTTAPI`：建议阅读类定义与方法名来判断职责。
