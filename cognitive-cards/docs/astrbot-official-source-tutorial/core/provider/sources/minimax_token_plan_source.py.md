# 文件教程：core/provider/sources/minimax_token_plan_source.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\provider\sources\minimax_token_plan_source.py`
- 文件类型：`.py`
- 文件大小：`1926` 字节
...
这个文件主要定义了 ProviderMiniMaxTokenPlan 等顶层类。
...
- `ProviderMiniMaxTokenPlan`：MiniMax Token Plan provider
