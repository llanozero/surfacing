# 文件教程：core/provider/sources/sensevoice_selfhosted_source.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\provider\sources\sensevoice_selfhosted_source.py`
- 文件类型：`.py`
- 文件大小：`4206` 字节
...
- `ProviderSenseVoiceSTTSelfHost`：建议阅读类定义与方法名来判断职责。
