# 文件教程：core/provider/sources/xai_source.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\provider\sources\xai_source.py`
- 文件类型：`.py`
- 文件大小：`1116` 字节
