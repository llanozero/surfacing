# 文件教程：core/provider/sources/zhipu_source.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\provider\sources\zhipu_source.py`
- 文件类型：`.py`
- 文件大小：`628` 字节
...
- `ProviderZhipu`：建议阅读类定义与方法名来判断职责。
