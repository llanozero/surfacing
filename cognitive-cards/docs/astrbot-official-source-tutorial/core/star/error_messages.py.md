# 文件教程：core/star/error_messages.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\star\error_messages.py`
- 文件类型：`.py`
- 文件大小：`691` 字节
...
- `format_plugin_error`：建议阅读函数签名和调用位置来判断用途。
