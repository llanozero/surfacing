# 文件教程：core/star/session_llm_manager.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\star\session_llm_manager.py`
- 文件类型：`.py`
- 文件大小：`5892` 字节
...
- `SessionServiceManager`：管理会话级别的服务启停状态，包括LLM和TTS
