# 文件教程：core/star/updator.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\star\updator.py`
- 文件类型：`.py`
- 文件大小：`3244` 字节
...
- `PluginUpdator`：建议阅读类定义与方法名来判断职责。
