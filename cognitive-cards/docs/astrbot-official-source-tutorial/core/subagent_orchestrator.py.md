# 文件教程：core/subagent_orchestrator.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\subagent_orchestrator.py`
- 文件类型：`.py`
- 文件大小：`3878` 字节
...
这个文件主要定义了 SubAgentOrchestrator 等顶层类。
...
- `SubAgentOrchestrator`：Loads subagent definitions from config and registers handoff tools
