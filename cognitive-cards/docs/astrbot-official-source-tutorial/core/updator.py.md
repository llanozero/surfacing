# 文件教程：core/updator.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\updator.py`
- 文件类型：`.py`
- 文件大小：`6949` 字节
...
- `AstrBotUpdator`：AstrBot 更新器，继承自 RepoZipUpdator 类
