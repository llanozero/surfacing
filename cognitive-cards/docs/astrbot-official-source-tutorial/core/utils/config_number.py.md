# 文件教程：core/utils/config_number.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\utils\config_number.py`
- 文件类型：`.py`
- 文件大小：`1805` 字节
...
这个文件主要提供了 coerce_int_config 等顶层函数。
...
- `coerce_int_config`：建议阅读函数签名和调用位置来判断用途。
