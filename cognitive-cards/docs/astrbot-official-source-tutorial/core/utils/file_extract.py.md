# 文件教程：core/utils/file_extract.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\utils\file_extract.py`
- 文件类型：`.py`
- 文件大小：`720` 字节
...
这个文件主要提供了 extract_file_moonshotai 等顶层函数。
...
- `extract_file_moonshotai`：Extract text from a file using Moonshot AI API
