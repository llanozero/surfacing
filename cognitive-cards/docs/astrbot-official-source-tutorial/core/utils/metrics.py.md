# 文件教程：core/utils/metrics.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\utils\metrics.py`
- 文件类型：`.py`
- 文件大小：`2597` 字节
