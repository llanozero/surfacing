# 文件教程：core/utils/path_util.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\utils\path_util.py`
- 文件类型：`.py`
- 文件大小：`3121` 字节
