# 文件教程：core/utils/plugin_kv_store.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\utils\plugin_kv_store.py`
- 文件类型：`.py`
- 文件大小：`882` 字节
...
这个文件主要定义了 PluginKVStoreMixin 等顶层类。
...
- `PluginKVStoreMixin`：为插件提供键值存储功能的 Mixin 类
