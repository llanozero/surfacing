# 文件教程：core/utils/t2i/renderer.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\core\utils\t2i\renderer.py`
- 文件类型：`.py`
- 文件大小：`2081` 字节
