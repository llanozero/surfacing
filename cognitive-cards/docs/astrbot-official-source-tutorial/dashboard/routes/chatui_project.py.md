# 文件教程：dashboard/routes/chatui_project.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\dashboard\routes\chatui_project.py`
- 文件类型：`.py`
- 文件大小：`8968` 字节
...
这个文件主要定义了 ChatUIProjectRoute 等顶层类。
...
- `ChatUIProjectRoute`：建议阅读类定义与方法名来判断职责。
