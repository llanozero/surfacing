# 文件教程：dashboard/routes/command.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\dashboard\routes\command.py`
- 文件类型：`.py`
- 文件大小：`3875` 字节
...
- `from astrbot.core.star.command_management import list_command_conflicts, list_commands`
...
- `from astrbot.core.star.command_management import update_command_permission`
- `from route import Response, Route, RouteContext`

## 顶层类

- `CommandRoute`：建议阅读类定义与方法名来判断职责。

## 顶层函数

- `_get_command_payload`：建议阅读函数签名和调用位置来判断用途。
