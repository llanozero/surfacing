# 文件教程：dashboard/routes/log.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\dashboard\routes\log.py`
- 文件类型：`.py`
- 文件大小：`4867` 字节
...
- `LogRoute`：建议阅读类定义与方法名来判断职责。

## 顶层函数

- `_format_log_sse`：辅助函数：格式化 SSE 消息
