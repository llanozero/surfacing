# 文件教程：dashboard/routes/plugin.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\dashboard\routes\plugin.py`
- 文件类型：`.py`
- 文件大小：`35643` 字节
...
这个文件主要定义了 RegistrySource、PluginRoute 等顶层类。
...
- `RegistrySource`：建议阅读类定义与方法名来判断职责。
- `PluginRoute`：建议阅读类定义与方法名来判断职责。
