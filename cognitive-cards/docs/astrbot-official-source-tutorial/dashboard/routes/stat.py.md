# 文件教程：dashboard/routes/stat.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\dashboard\routes\stat.py`
- 文件类型：`.py`
- 文件大小：`23163` 字节
