# 文件教程：dashboard/routes/subagent.py

## 文件定位

- 官方路径：`C:\Users\llano\AppData\Local\AstrBot\backend\app\astrbot\dashboard\routes\subagent.py`
- 文件类型：`.py`
- 文件大小：`4875` 字节
...
- `SubAgentRoute`：建议阅读类定义与方法名来判断职责。
